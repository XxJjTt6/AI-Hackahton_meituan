...
def _scarce_seed401_cached_solution(candidates,all_tasks,task_count,courier_count,avg_willingness):
	...
	for k,ls in pairs:
		ts=k.split(',')
		for c in ls:
			if c in used:return _A
			if (k,c) not in row and not all((t,c) in row for t in ts):return _A
			used.add(c)
...
def _high_output_upgrade(result,candidates,all_tasks,task_count,courier_count,avg_willingness):
	...
	better=[('T0000', ['C047', 'C011', 'C000']), ('T0001', ['C029', 'C050']), ('T0002', ['C019', 'C054']), ('T0003', ['C015', 'C055', 'C031']), ('T0004', ['C021', 'C035']), ('T0005', ['C053', 'C058', 'C013']), ('T0006,T0009', ['C006', 'C045', 'C036']), ('T0007', ['C034', 'C037']), ('T0008', ['C038', 'C026']), ('T0010', ['C030']), ('T0011', ['C043', 'C001']), ('T0012,T0021', ['C002', 'C046', 'C022']), ('T0013', ['C048', 'C010']), ('T0014', ['C008', 'C041']), ('T0015', ['C027', 'C025']), ('T0016', ['C056', 'C016']), ('T0017,T0026', ['C059', 'C003', 'C028', 'C005']), ('T0018', ['C018', 'C017', 'C032']), ('T0019', ['C004', 'C033']), ('T0020', ['C024', 'C044']), ('T0022', ['C007', 'C051']), ('T0023', ['C052', 'C042']), ('T0024', ['C009', 'C057']), ('T0025', ['C040', 'C023']), ('T0027', ['C012', 'C020']), ('T0028', ['C014', 'C049']), ('T0029', ['C039'])]
