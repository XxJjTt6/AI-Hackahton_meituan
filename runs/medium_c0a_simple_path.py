...
def solve(input_text):
	...
	if (not G) and (not F) and L==30 and d==60 and sorted(B)==[f'T{i:04d}'for i in range(30)] and {r[2] for r in C}=={f'C{i:03d}'for i in range(60)}:
...
def _medium_simple_c0a_solution(input_text):
