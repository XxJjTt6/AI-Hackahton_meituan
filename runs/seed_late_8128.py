...
def _low_late_acceptance_repair_solution(result,candidates,all_tasks,deadline):
	P=deadline;M=result;I=all_tasks;D=candidates;W={(A[0],A[2]):A for A in D};Q=_task_adjacency(D);R=random.Random(8128+len(D));N=M;S=M;E=_solution_expected_cost(N,D,I);T=E;O=[E]*10;B=0
