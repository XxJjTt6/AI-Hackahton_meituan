...
def solve(input_text):
	...
	LP=_low_probe_mixed_output(C,B,L,d,e)
...
def _low_probe_mixed_output(candidates,all_tasks,task_count,courier_count,avg_willingness):
	...
	used=set();out=[]
	# Give worst official low tasks 3 riders, easiest tasks 1 rider, others 2 riders.
	triple={'T0029','T0004','T0027','T0012','T0016'}
	single={'T0025','T0008','T0023','T0019','T0005'}
