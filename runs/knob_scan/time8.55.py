...
def solve(input_text):
	h=input_text;global _GROUP_COST_CACHE,_LOW_BIAS_ACTIVE;_GROUP_COST_CACHE={};i=time.monotonic();A=i+8.55;b=h.strip().splitlines();A2=1 if b and b[0].startswith(_K)else 0;C=[];B=set()
