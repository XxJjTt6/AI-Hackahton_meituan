...
def solve(input_text):
	...
	if J and time.monotonic()<A-.95:D=_pces(D,C,B,min(A,time.monotonic()+.85),top_riders_per_task_key=14,max_k=5,option_limit=120,max_window_tasks=12,max_pairs=80)
