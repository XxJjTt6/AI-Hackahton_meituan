...
def _random_single_start_solution(singles,all_tasks,deadline):
	...
	D=min(E,time.monotonic()+1.8);F=_greedy_repair_single({},B,C,random.Random(42),.5);A=_format_selected(F);A=_reassign_single_solution(A,B,C,D);A=_rebalance_single_solution(A,B,C,D);A=_reassign_single_solution(A,B,C,D);return A
