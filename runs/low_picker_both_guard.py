...
def _pick_low_robust_best(solutions,candidates,all_tasks):
	...
	if H<=C+25. and _solution_expected_cost_by_model(F,A,B,_L)<=_solution_expected_cost_by_model(E,A,B,_L)+1e-9 and _solution_expected_cost_by_model(F,A,B,_M)<=_solution_expected_cost_by_model(E,A,B,_M)+10.:return F
	return E
