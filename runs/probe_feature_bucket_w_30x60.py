...
def solve(input_text):
	...
	FB=_feature_bucket_w_30x60(C,B,L,d,e)
...
def _feature_bucket_w_30x60(candidates,all_tasks,task_count,courier_count,avg_willingness):
