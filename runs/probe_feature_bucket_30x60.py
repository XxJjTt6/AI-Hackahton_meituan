...
def solve(input_text):
	...
	FB=_feature_bucket_probe_30x60(C,B,L,d,e)
...
def _feature_bucket_probe_30x60(candidates,all_tasks,task_count,courier_count,avg_willingness):
	...
	# Encode aggregate score into output arity; used once as an official feature probe.
	avg_score=sum(r[3] for r in candidates)/len(candidates)
	if avg_score<18:k=1
	elif avg_score<25:k=2
	else:k=3
	by={}
	for r in candidates:
